<template>
  <div id="horary" class="horary bg-blue text-white">
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center">
          <h2 class="text-warning questions__subtitle title-with-border">Calendario</h2>
        </div>
      </div>
...
<style lang="scss">
.horary {
  background-image: url("/trazado-28.png");
